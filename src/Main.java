...
public class Main {
    ...
    public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException {
        ...
        System.out.println("Timeout (Max):");
        int maxtimeout = Integer.parseInt(scanner.nextLine());
        System.out.println("Timeout (Min):");
        int mintimeout = Integer.parseInt(scanner.nextLine());
